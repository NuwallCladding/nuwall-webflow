...
const entries = ['global', 'persona-init', 'drawings-viewer', 'colour-picker', 'home-page', 'colour-page', 'inspiration-page', 'resources-page', 'profiles-page', 'series-page', 'projects-page'];
